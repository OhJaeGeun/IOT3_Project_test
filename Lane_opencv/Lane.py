...
def main():
  ...
  lane_obj.plot_roi(plot=True) # org = False
 
  # Perform the perspective transform to generate a bird's eye view
  # If Plot == True, show image with new region of interest
  warped_frame = lane_obj.perspective_transform(plot=True) # org = False
 
  # Generate the image histogram to serve as a starting point
  # for finding lane line pixels
  histogram = lane_obj.calculate_histogram(plot=True)  # org = False
  ...
  lane_obj.get_lane_line_previous_window(left_fit, right_fit, plot=True) # org = False
     
  # Overlay lines on the original frame
  frame_with_lane_lines = lane_obj.overlay_lane_lines(plot=True) # org = False
 
  # Calculate lane line curvature (left and right lane lines)
  lane_obj.calculate_curvature(print_to_terminal=True) # org = False
 
  # Calculate center offset                                                                 
  lane_obj.calculate_car_position(print_to_terminal=True) # org = False
